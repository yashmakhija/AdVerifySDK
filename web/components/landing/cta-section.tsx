    ...
    <section className="relative w-full bg-black border-t border-white/[0.06]">
      <div className="mx-auto max-w-6xl px-5 md:px-8 py-6">
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] px-6 py-16 md:px-16 md:py-24 text-center">
          ...
          />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[500px] bg-[radial-gradient(ellipse_at_center,var(--brand-glow)_0%,transparent_70%)]" />
          ...
          <div className="relative">
            ...
            <div className="mt-9 flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link href="/login">
                <button
                  className="group flex items-center gap-2 rounded-full bg-white px-7 py-3 text-[14px] font-semibold text-black transition-all hover:bg-zinc-200 active:scale-[0.97]"
