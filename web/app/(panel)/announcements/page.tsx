        ...
        <div className="flex flex-col gap-3">
          {items.map((item) => {
            ...
            return (
              <div
                key={item.id}
                className="rounded-xl border border-border bg-surface p-4 sm:p-5 transition-colors hover:bg-surface-2"
              >
                <div className="flex items-start justify-between gap-3">
                  <div className="flex items-start gap-3 min-w-0">
                    <div className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-border bg-surface">
                  ...
                  <button
                    ...
                    className="shrink-0 flex h-7 w-7 items-center justify-center rounded-lg text-faint transition-colors hover:bg-red-500/10 hover:text-red-400"
                  >
