        ...
        >
          <div className="p-4 space-y-3">
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <h3 className="font-medium text-foreground truncate">{k.appName}</h3>
                <p className="text-[11px] text-faint mt-0.5">{k.packageName || "-"}</p>
                {isAdmin && (
            ...
            <div>
              <p className="text-[11px] font-medium uppercase tracking-wider text-faint mb-1.5">
                API Key
              </p>
          ...
          <div className="flex border-t border-border divide-x divide-border">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-xs font-medium text-muted-foreground transition-colors hover:bg-surface-2 active:bg-surface-2"
            >
              {k.isActive ? (
